...
export const LEGACY_SETUP_COMPLETED_KEY = "auracoder.setup.completed.v2";
export const ONBOARDING_COMPLETED_KEY = "auracoder.onboarding.completed.v1";
export const ONBOARDING_WORKFLOW_KEY = "auracoder.onboarding.workflow.v1";
export const ONBOARDING_CHAT_ENGINES_KEY = "auracoder.onboarding.chatEngines.v1";
